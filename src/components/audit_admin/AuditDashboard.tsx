      ...
      {!auditId ? (
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-gray-600">No audit selected. Please select an audit from the list.</p>
            <Button 
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600">Loading audit status...</p>
          </CardContent>
        </Card>
      ) : (
        <>
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-4">
              <Button 
                onClick={() => onNavigate("audit-verify", auditId)} 
