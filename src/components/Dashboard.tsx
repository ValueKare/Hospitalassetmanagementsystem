...
export const getDashboardSummary = async () => {
  try {
    console.log('Fetching summary from:', `${import.meta.env.VITE_API_URL}/api/dashboard/summary`);
...
export const getAssetsByDepartment = async () => {
  try {
    console.log('Fetching assets by department from:', `${import.meta.env.VITE_API_URL}/api/dashboard/assets-by-department`);
...
export const getUtilizationData = async () => {
  try {
    console.log('Fetching utilization from:', `${import.meta.env.VITE_API_URL}/api/dashboard/utilization`);
...
export const getCostTrends = async () => {
  try {
    console.log('Fetching cost trends from:', `${import.meta.env.VITE_API_URL}/api/dashboard/cost-trends`);
...
export const getDashboardAlerts = async () => {
  try {
    console.log('Fetching alerts from:', `${import.meta.env.VITE_API_URL}/api/dashboard/alerts`);
